...
/// @dev A mintable BEP20 token that allows anyone to pay and distribute BUSD
...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface {
  ...
  /// @notice Withdraws the BUSD distributed to the sender.
  /// @dev It emits a `DividendWithdrawn` event if the amount of withdrawn BUSD is greater than 0.
